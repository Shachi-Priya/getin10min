  ...
  return (
    <>
      ...
      <section className="section container-tight">
        ...
        <p className="mt-2 text-slate-300">Fill the form and we will contact you via email/phone. The brand name "getin10min" is just a name — quality takes thoughtful time.</p>
        <div className="mt-8">
