  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="We craft fast, beautiful, SEO-friendly websites to help your business grow. Contact us for static and dynamic sites, branding, and more."
        />
      </Head>
      ...
      <section className="section container-tight">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold">
            Why choose getin10min?
          </h2>
          <p className="mt-3 text-slate-300">
            The name is catchy, but our focus is on quality. We deliver
            thoughtful design, clean code, and results.
          </p>
        </div>
